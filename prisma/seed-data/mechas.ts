...
export const MECHA_SEED_DATA: MechaConfig[] = [
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 5, name: "永续型", threshold: 160, imageUrl: "/mecha/ark/level-5.png", description: "战场后勤核心觉醒，持久战保障之威尽显。" },
  ...
  },
  {
    slug: "hound",
    name: "猎犬",
    description: "四足突击型仿生机甲，擅长高速冲刺与近战撕咬",
    intro: "猎犬, 四足突击型仿生机甲, 擅长高速冲刺与近战撕咬, 是战场上的四足猎手，凭借高速机动与近战能力，专攻落单与薄弱目标，是突击与追击的利器。负责快速突击、近战压制、敌后骚扰、单点歼灭。它在历练中不断觉醒，解锁更强形态、等离子利齿与冲刺推进器，每一次蜕变都让猎杀之力更强。",
    sortOrder: 13,
    levels: [
      { level: 0, name: "量产型", threshold: 0, imageUrl: "/mecha/hound/level-0.png", description: "基础四足冲刺与利齿撕咬，可执行突击任务。" },
      { level: 1, name: "改良型", threshold: 20, imageUrl: "/mecha/hound/level-1.png", description: "冲刺推进器初显，机动性增强。" },
      { level: 2, name: "特装型", threshold: 50, imageUrl: "/mecha/hound/level-2.png", description: "等离子利齿强化，咬合穿透力提升。" },
      { level: 3, name: "强化型", threshold: 80, imageUrl: "/mecha/hound/level-3.png", description: "扑击动作成型，单点歼灭效率显著提升。" },
      { level: 4, name: "追猎型", threshold: 120, imageUrl: "/mecha/hound/level-4.png", description: "冲刺推进器加身，追击与撤离能力大幅增强。" },
      { level: 5, name: "狂犬型", threshold: 160, imageUrl: "/mecha/hound/level-5.png", description: "等离子利齿全开，近战压制之威尽显。" },
