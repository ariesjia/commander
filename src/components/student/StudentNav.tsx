...
export function StudentNav() {
  ...
  return (
    <nav className="student-nav-bar theme-student z-50 flex min-h-16 items-center justify-around border-t border-[rgba(0,212,255,0.15)] bg-[#0c1222]/95 backdrop-blur-lg pb-[env(safe-area-inset-bottom,0px)]">
